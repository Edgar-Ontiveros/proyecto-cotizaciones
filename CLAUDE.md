...
uv run python -m app.scheduler                     # scheduler (proceso aparte; SCHEDULER_BANDAS_SEGUNDOS / SCHEDULER_OC_SEGUNDOS para bajar los intervalos en dev)
